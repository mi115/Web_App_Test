...
from first_site.infrastructure.num_convert import try_int
import first_site.data.db_session as db_session
from first_site.data.languages import ProgrammingLanguage
from first_site.data.licenses import License
from first_site.data.maintainers import Maintainer
...
def do_load_files() -> List[dict]:
    data_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '../data/example_data/pypi-top-100'))
